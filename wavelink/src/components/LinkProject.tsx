...
import { collection, addDoc, setDoc, query, where, doc, updateDoc } from "firebase/firestore" 
...
import LinkProjectGrid from "./LinkProjectGrid"


function LinkProject(idea: any) {
    ...
    const onUploadProject = async() => {
        ...
        try {
            ...
            const project = await addDoc(projectsCollectionRef, {title: newProjectTitle, date: newDate, user: user, username: userName, description: description, imageurls: imageUrlList});
  ...
  return (
    ...
    <Center>
        ...
        <Tabs isFitted  borderRadius={25}>
            <TabList mb='1em'>
                <Tab>Link New Project</Tab>
                <Tab>Link Existing Project</Tab>
